var Layout = {
	fit: function(tiles, width, height, minWidth, minHeight) {
		return 	this.screenFit.apply(this, arguments) || 
						this.pageFit.apply(this, arguments);
	},
	
	screenFit: function(tiles, width, height, minWidth, minHeight) {
